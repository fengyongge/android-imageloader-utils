package com.fengyongge.friendscircle;
...
import com.fengyongge.friendscircle.bean.FriendBean;
import com.fengyongge.friendscircle.bean.PicBean;
import com.fengyongge.friendscircle.bean.ReplyBean;
import com.fengyongge.friendscircle.utils.StringUtils;
...
//                    index = discuss_friend.getPosition();
            ...
            holder.shareLL.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ToastUtils.showToast(FirendsCircleActivity.this,"去分享");
                }
            });
    ...
    private void initPopWindow() {
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                if (StringUtils.isNotEmpty(replyEdit.getText().toString()
                        .trim())
                        && discuss_reply != null) {
                    ...
                    if (is_item) {
                        ...
                        remove.getComment_list().add(0, discuss_reply);
                        if (StringUtils.isNotEmpty(remove.getComment_total())) {
